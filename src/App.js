        ...
        <article>
            ...
            <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">          
                ...
                <div className="mt-4 md:mt-0 text-center -mr-28">
                    ...
                    <Typewriter className="text-gray-500"
                            options={{
                ...
                <div className='mt-4 md:mt-0'>
                        <img src='https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/dark-star.png' alt='profile' />
                </div>
            </div>
            </section>
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      ...
      <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/snippex.png" alt="Bonnie Avatar"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Snippex</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">ReactJS, Redux</span>
                  <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/dashboard.png" alt="Jese Avatar"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Integrated Dashboard</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">ReactJS + TailwindCSS</span>
                  <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                  <ul className="flex space-x-4 sm:mt-0">
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/pos.png" alt="Michael Avatar"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">POS</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">Java, JavaFX, MySQL</span>
                  <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
                  <ul className="flex space-x-4 sm:mt-0">
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg w-96" src="https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/monstarlab.png" alt="Sofia Avatar"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Monstarlab Movies</a>
                  </h3>
                  <span className="text-gray-500 dark:text-gray-400">Lorem Ipsum</span>
                  <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Browse your favorite movies.</p>
                  <ul className="flex space-x-4 sm:mt-0">
