...
function App() {
   ...
   <>
      ...
      <main className='bg-white min-h-screen dark:bg-gray-900'>
        ...
        <article>
            ...
            <section className='mt-0 h-[100vh]'>
            <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">          
                
                
                <div className="mt-4 md:mt-0 flex justify-center">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-green-400">John Ray D. Paulin</h2>
                    <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">Frontend Developer</p>
                    
                </div>
                <div className='mt-4 md:mt-0'>
                        <img src='https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/dark.png' alt='profile' />
                </div>
            </div>
            </section>
            ...
            <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                ...
                <div class="mt-4 md:mt-0">
                    ...
                    <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">This portfolio is a work in progress...</p>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          ...
          <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Explore the whole collection of open-source web projects created using different tech stacks.</p>
      </div> 
      <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/snippex.png" alt="Bonnie Avatar"/>
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Snippex</a>
                  </h3>
                  <span class="text-gray-500 dark:text-gray-400">ReactJS, Redux</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/dashboard.png" alt="Jese Avatar"/>
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Integrated Dashboard</a>
                  </h3>
                  <span class="text-gray-500 dark:text-gray-400">ReactJS + TailwindCSS</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                  <ul class="flex space-x-4 sm:mt-0">
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/pos.png" alt="Michael Avatar"/>
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">POS</a>
                  </h3>
                  <span class="text-gray-500 dark:text-gray-400">Java, JavaFX, MySQL</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
                  <ul class="flex space-x-4 sm:mt-0">
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://raw.githubusercontent.com/genmancoder/portfolio/staging/src/assets/pos.png" alt="Sofia Avatar"/>
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Lorem Ipsum</a>
                  </h3>
                  <span class="text-gray-500 dark:text-gray-400">Lorem Ipsum</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
                  <ul class="flex space-x-4 sm:mt-0">
...
<footer className=" p-4 bg-white sm:p-6 dark:bg-gray-900">
    ...
    <div className="sm:flex sm:items-center sm:justify-between container">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">Genman™</a>. All Rights Reserved. Built with React + TailwindCSS
        </span>
